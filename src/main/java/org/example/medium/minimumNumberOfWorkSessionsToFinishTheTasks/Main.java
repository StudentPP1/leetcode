...
public class Main {
    /*
    ! Сначала добавляем самые большие, а потом добавляем к ним по меньше
    ! Так как мы делаем рекурсивно нам легко откатится назад и добавить меньший элемент э
    ! к первой сессии, а не второй
    ! по факту перебираем все возможные варианты, рекурсивным способом, а если не вышло, просим еще одну сессию
    */
